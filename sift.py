...
def perform_sift(image1, keypoints1, image2, keypoints2):
    ...
    keypoint_descriptors1, keypoint_coords1 = create_descriptor(keypoint_descriptors1, keypoint_histogram1, keypoints1,
                                                                orientations1)
    keypoint_descriptors2, keypoint_coords2 = create_descriptor(keypoint_descriptors2, keypoint_histogram2, keypoints2,
                                                                orientations2)
